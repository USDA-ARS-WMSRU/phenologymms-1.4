...
//this constructor is for loading a scenario from a file
    ...
    private void jbInit() throws Exception {
        ...
        jRBNumber3.setText("TI to Single Ridge");
        ...
        jRBNumber18.setText("TI to Single Ridge");
        ...
        jRBNumber32.setText("TI to Single Ridge");
        ...
        jRBNumber47.setText("TI to Single Ridge");
    ...
    void jHelpButton_actionPerformed(ActionEvent e) {
		//if(RoboHelp.openHelpPage("Growth_Stages/Hay_Millet_Growth_Stages.htm")) {
                if(RoboHelp.openHelpPage("Hay_Millet_Growth_Stages.htm")) {
			return;
		}
