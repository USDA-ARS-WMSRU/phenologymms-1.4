...
/**
 *
 * @author debbie.edmunds
 */
public class TempSettingsHelpFrame extends JFrame {
GridBagLayout jGridBagLayout = new GridBagLayout(); // DE added
  ...
  //panes
  JScrollPane jSPTempSettingsHelp = new JScrollPane();
  JTextPane jTPTempSettingsHelp= new JTextPane();  
  
  // de added Close button
  JButton jBClose = new JButton();
    
    /** Creates a new instance of TempSettingsHelpFrame */
  // constructor
    public TempSettingsHelpFrame() {
         try {
    ...
    jTitleLabel.setText("Help For Temperature Settings Inputs");
        
    // de added for Exit button   
    jBClose.setText("Close");
    
    //scrollpane
        jSPTempSettingsHelp.setVerticalScrollBarPolicy
            (JScrollPane.VERTICAL_SCROLLBAR_ALWAYS);
        jSPTempSettingsHelp.setHorizontalScrollBarPolicy
            (JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);//de added
        jSPTempSettingsHelp.setPreferredSize(new Dimension(500, 400)); 
        
        //textpane
        jSPTempSettingsHelp.setFont(new java.awt.Font("DialogInput", 1, 12));
        
        readFile(new File(getAppPath() + "/TemperaturesHelp.txt"));
        jTPTempSettingsHelp.setText(helpTempSettings);
        ...
        addItem(jSPTempSettingsHelp, 0, 0, 1, 1,  "jCenterPanel");
        jSPTempSettingsHelp.getViewport().add(jTPTempSettingsHelp, null);              
       ...
       public void readFile(File aFile){  //String
        ...
        try{
            ...
            while((newLine = in.readLine())!= null){
                ...
                helpTempSettings = buffer.toString();
            }  
        ...
        setOutput(helpTempSettings);
    }  
    
    public void setOutput(String fortOutput){
        helpTempSettings = fortOutput;
    }
    
    public String getOutput() {
        return helpTempSettings;
    }
  ...
  } // end of TempSettingsHelpFrame class     
